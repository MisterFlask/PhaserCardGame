...
export class ArchonClass extends BaseCharacterClass {
    ...
    constructor() {
        ...
        this.longDescription = "The East Infernal Company's Archons are Her Majesty's chosen overseers of expeditions into the infernal realms. Part military officer, part occult specialist, they command absolute authority over their charges - as decreed by both Crown and Contract."
        this.availableCards = [
            // common
            new Bolster(),
            new Buzzsword(),
