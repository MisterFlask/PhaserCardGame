# BACKGROUND
 ...
 It is now five years later, in 1890. The East Infernal Company, a joint venture between the British Trade Delegation and several prominent Brimstone Barons, has established a state-sponsored monopoly on trans-dimensional shipping between London and Dis, chartered for operations as far down as the Third Circle. Their fleet of iron-clad amphibious land-crawlers, specially fitted with Maxwell coils and blessed hull plating, makes regular runs through the Buckingham Rift carrying cargo, colonists, and even important political dignitaries.
