...
const EXPECTED_MISSING_IMAGE_REFS: { file: string; value: string }[] = [
    ...
    { file: 'encounters/monsters/act1_boss/BloatedTreasurer.ts', value: "Lost Accountant" },
    // TODO.md-tracked bug (same class as the fixed FrenchBlindProphetess
    // "doris-smith" bug): "hermit" was never added to the manifest.
    { file: 'encounters/monsters/act1_boss/HermitProphetOfTheDelta.ts', value: "hermit" },
    { file: 'encounters/monsters/act1_boss/HermitsTreasure.ts', value: "running-ninja" },
    { file: 'encounters/monsters/act1_boss/HermitsTreasure.ts', value: "treasure" },
    { file: 'encounters/monsters/act1_segment1/act1_segment0/Brigand.ts', value: "ferryman_mutineer" },
    { file: 'encounters/monsters/act1_segment1/BoatmanRevenant.ts', value: "f" },
    { file: 'encounters/monsters/act1_segment1/BoatmanRevenant.ts', value: "ghost_ship" },
    { file: 'encounters/monsters/act1_segment1/BogLampreyOUS.ts', value: "Horror Worm" },
    { file: 'encounters/monsters/act1_segment1/BrimstoneMudskipper.ts', value: "Salamander" },
    { file: 'encounters/monsters/act1_segment1/DisgruntledFerryman.ts', value: "Drowned Sailor" },
    { file: 'encounters/monsters/act1_segment1/FareEnforcer.ts', value: "fare_enforcer" },
    { file: 'encounters/monsters/act1_segment1/SkeeterwispSwarm.ts', value: "heal" },
    { file: 'encounters/monsters/act1_segment1/SootLungHeron.ts', value: "Corrupted Bird" },
    { file: 'encounters/monsters/act1_segment1/TelegraphEel.ts', value: "Electric Eel" },
    { file: 'encounters/monsters/act1_segment2/RaftPirate.ts', value: "Pirate" },
    { file: 'encounters/monsters/act1_segment2/Rootwrithe.ts', value: "totem_2" },
    { file: 'encounters/monsters/act1_segment2/RunoffElemental.ts', value: "Ooze" },
    { file: 'encounters/monsters/act1_segment2/TollCollectorGoneMad.ts', value: "Lost Accountant" },
