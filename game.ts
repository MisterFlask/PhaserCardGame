  ...
  class CardGame extends Phaser.Scene {
      ...
      createGameAreas(): void {
          ...
          this.battlefieldArea = this.add.rectangle(gameWidth / 2, battlefieldY, 700, 300).setStrokeStyle(4, 0xffff00);
          this.handArea = this.add.rectangle(gameWidth / 2, handY, 700, 300).setStrokeStyle(4, 0x00ff00);
